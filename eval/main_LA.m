...
%Models = {'Eff_TransSeg_B4_Endo'}; %{'UNet','UNet++','PraNet','SFA'}; 
%Models = {'ESFP_B4_Endo_CVC-ClinicDB_LA_1'};
Models = {'ESFP_B4_Endo_Kvasir_LA_1'};

%Models = {'Transeg_B4_average_adpative','Transeg_B4_optimize_adpative','Transeg_B2_average_adpative','Transeg_B2_optimize_adpative'};
%Models = {'Transeg_B2_average_adpative'};
%Models = {'Test_two_B2_average','Test_two_B4_average'};
%Models = {'ESFP_B4_Endo_Test_AverageOptimal_1','ESFP_B4_Endo_Test_AverageOptimal_2','ESFP_B4_Endo_Test_AverageOptimal_3','ESFP_B4_Endo_Test_AverageOptimal_4','ESFP_B4_Endo_Test_AverageOptimal_5', ...
 %         'ESFP_B4_Endo_Test_DatasetBest_1','ESFP_B4_Endo_Test_DatasetBest_2','ESFP_B4_Endo_Test_DatasetBest_3','ESFP_B4_Endo_Test_DatasetBest_4','ESFP_B4_Endo_Test_DatasetBest_5', ...
  %  };
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath = '../Endoscope-WL/';
%Datasets = {'CVC-ClinicDB', 'CVC-ColonDB','ETIS-LaribPolypDB', 'Kvasir','CVC-300'};
%Datasets = {'ETIS-LaribPolypDB', 'CVC-ColonDB', 'Kvasir', 'CVC-ClinicDB'};
Datasets = {'Kvasir_Splited'};
...
for d = 1:datasetNum
    ...
    for m = 1:modelNum
        ...
        resTxt = [ResDir model '_' dataset ResName];  % The evaluation result will be saved in `../Resluts/Result-XXXX` folder.
        fileID = fopen(resTxt,'w');
        
        gtPath = [DataPath dataset '/testSplited/masks/']
